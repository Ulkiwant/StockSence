...
const FAQS = [
  ...
  { q: "Que signifient les signaux d'achat, de vente ou de neutralité ?", a: "Ces signaux indiquent l'écart entre le cours actuel et la valeur intrinsèque estimée : Achat fort (>+25%), Achat (+10% à +25%), Neutre (-20% à +10%), Vente (-30% à -20%), Vente forte (<-30%). Un signal Achat signifie que l'action semble décotée selon notre modèle." },
  ...
  { q: "Comment fonctionne le conseiller patrimonial IA ?", a: "Le conseiller utilise un modèle IA pour générer un portefeuille personnalisé selon votre profil : âge, tolérance au risque, horizon, capital, objectifs et préférences sectorielles. Il suggère des ETF et actions réels avec leurs symboles." },
    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "40px 28px 64px" }}>
        ...
        <p style={{ fontSize: 15, color: "var(--muted)", marginBottom: 36, lineHeight: 1.65 }}>
          Tout ce que vous devez savoir sur Rently et ses fonctionnalités.
        </p>
