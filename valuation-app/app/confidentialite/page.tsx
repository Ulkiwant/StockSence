...
export const metadata = {
  title: "Politique de confidentialité | StockSense",
  description: "Politique de confidentialité de StockSense — données collectées, cookies, droits RGPD.",
};
    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "48px 28px 64px" }}>
        ...
        <div style={{
          ...
          StockSense s'engage à protéger votre vie privée. Cette politique explique quelles données nous
        ...
        <div style={SECTION}>
          ...
          <p style={P_STYLE}>
            ...
            données biométriques, données de navigation hors StockSense, ni données sensibles au sens du RGPD.
          </p>
        </div>
        ...
        <div style={SECTION}>
          ...
          <p style={P_STYLE}>
            StockSense utilise uniquement des cookies <strong style={{ color: "var(--ink)" }}>strictement nécessaires</strong> au fonctionnement :
          </p>
          <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 6, marginBottom: 8 }}>
        ...
        <div style={SECTION}>
          ...
          <p style={P_STYLE}>
            ...
            <a href="mailto:contact@stocksense.fr" style={{ color: "var(--accent)" }}>contact@stocksense.fr</a>.
          </p>
        </div>
