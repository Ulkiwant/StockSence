...
const FAQS = [
  ...
  { q: "Que signifient les signaux de valorisation ?", a: "Ces signaux indiquent l'écart entre le cours actuel et la valeur intrinsèque estimée : Très sous-évalué (>+25%), Sous-évalué (+10% à +25%), Neutre (-20% à +10%), À surveiller (-30% à -20%), Surévalué (<-30%). Un signal Sous-évalué signifie que l'action semble décotée selon notre modèle." },
