...
export const metadata = {
  title: "Politique de confidentialité | Finazen",
  description: "Politique de confidentialité de Finazen — données collectées, cookies, droits RGPD.",
};
    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "48px 28px 64px" }}>
        ...
        <div style={{
          ...
          Finazen s'engage à protéger votre vie privée. Cette politique explique quelles données nous
        ...
        <div style={SECTION}>
          ...
          <p style={P_STYLE}>
            ...
            données biométriques, données de navigation hors Finazen, ni données sensibles au sens du RGPD.
          </p>
        </div>
        ...
        <div style={SECTION}>
          ...
          <p style={P_STYLE}>
            Finazen utilise uniquement des cookies <strong style={{ color: "var(--ink)" }}>strictement nécessaires</strong> au fonctionnement :
          </p>
          <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 6, marginBottom: 8 }}>
